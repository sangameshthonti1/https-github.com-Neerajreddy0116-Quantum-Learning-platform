...
export default function ChallengeProgressSummary({ detailed = false }: { detailed?: boolean }) {
  ...
  return <section id={detailed ? 'challenge-progress' : undefined} className="q-record-card challenge-progress" aria-label="Challenge progress"><div className="q-section-heading"><h2>Independent challenges</h2><Badge tone={completed ? 'success' : 'neutral'}>{completed} / {catalog.length} completed</Badge></div>
