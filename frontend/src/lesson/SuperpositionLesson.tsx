...
export default function SuperpositionLesson() {
  ...
  useEffect(() => {
    ...
    document.title = 'Superposition and the Hadamard Gate · Quantum Learning';
  ...
  return <main className="lab lesson">
    ...
    <header className="lesson-header"><a className="lab-brand" href="/" aria-label="Circuit Lab home">q</a><span>QUANTUM LEARNING <small>First steps</small></span><a href="/">Circuit Lab ↗</a></header>
    ...
    <div className="lesson-layout">
      <aside className="lesson-progress"><p>YOUR LEARNING PATH</p><p>Section {stage + 1} of {stages.length} · {completedCount} completed</p><progress aria-label="Lesson sections completed" max={stages.length} value={completedCount} />
        ...
        <p className="lesson-session">Progress stays in this tab’s session. It is not saved to an account. If browser storage is blocked, leaving or refreshing this page clears progress.</p>
      </aside>
